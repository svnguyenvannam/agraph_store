...
public class MainForm extends javax.swing.JFrame {
	...
	public static ServerConnection serverConnection = ServerConnection.getDatabaseConnecter(severURL, user, password);
	...
	private void initComponents() {
		...
		comboChooseStatement.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "query 1 ", "query 2 ",
				"query 3 ", "query 4 ", "query 5 ", "query 6 ", "query 7 ", "query 8 ", "query 9 ", "query 10 " }));
		...
		comboChooseDB.setModel(new javax.swing.DefaultComboBoxModel<>(
				new String[] { "100_entity_200_relation", "5000_entity_7000_relation", "60000_entity_80000_relation",
						"100000_entity_200000_relation", "500000_entity_1000000_relation" }));
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(14, 14, 14).addGroup(jPanel1Layout
								...
								.addGroup(jPanel1Layout
										.createSequentialGroup().addGroup(jPanel1Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(jLabel2).addComponent(jLabel4).addComponent(comboChooseDB,
												...
												.addGroup(jPanel1Layout.createSequentialGroup().addGap(31, 31, 31)
														.addGroup(jPanel1Layout
																...
																.addComponent(advancedQuery).addComponent(basicQuery)))
								...
								.addGroup(jPanel1Layout.createSequentialGroup()
										.addComponent(jScrollPane3, javax.swing.GroupLayout.PREFERRED_SIZE, 436,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(queryRun).addGap(146, 146, 146))))
						.addGroup(jPanel1Layout.createSequentialGroup()
								.addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 1065,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(4, 4, 4)))
		...
		jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { comboChooseDB, comboChooseStatement });
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(35, 35, 35).addGroup(jPanel1Layout
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addComponent(jLabel2)
								...
								.addComponent(advancedQuery).addGap(51, 51, 51).addComponent(jLabel5)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(comboChooseDB, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 59,
										Short.MAX_VALUE)
								.addComponent(jLabel4)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(comboChooseStatement, javax.swing.GroupLayout.PREFERRED_SIZE, 45,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(13, 13, 13))
						.addGroup(jPanel1Layout.createSequentialGroup()
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jScrollPane3, javax.swing.GroupLayout.PREFERRED_SIZE, 98,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGroup(jPanel1Layout.createSequentialGroup().addGap(24, 24, 24)
										.addComponent(queryRun)))
						.addGap(18, 18, 18).addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 337,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(20, 20, 20)));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(jPanel1,
								javax.swing.GroupLayout.PREFERRED_SIZE, 1103, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap()));
	...
	private void queryRunActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_queryRunActionPerformed
		...
		if (comboChooseDB.getSelectedIndex() == 0) {
			conn = serverConnection.getConnection("100_entity_200_relation");
		} else if (comboChooseDB.getSelectedIndex() == 1) {
			conn = serverConnection.getConnection("5000_entity_7000_relation");
		} else if (comboChooseDB.getSelectedIndex() == 2) {
			conn = serverConnection.getConnection("60000_entity_80000_relation");
		} else if (comboChooseDB.getSelectedIndex() == 3) {
			conn = serverConnection.getConnection("100000_entity_200000_relation");
		} else if (comboChooseDB.getSelectedIndex() == 4) {
			conn = serverConnection.getConnection("500000_entity_1000000_relation");
		}
