...
public class DataStoreder {
    ...
    public void storeEntity(HashMap<Object, Object> properties) {
        ...
        IRI dinhDanh = vf.createIRI(entityCollection.ENTITY_PREFIX, (String) properties.get("định_danh"));
        IRI type = vf.createIRI(entityCollection.CLASS_PREFIX, (String) properties.get("thực_thể"));
        ...
        properties.forEach((key, value) -> {
            Literal o;
            IRI p = vf.createIRI(entityCollection.PROPERTIES_PREFIX, (String) key);
            if (value instanceof String) {
                o = vf.createLiteral((String) value);
            } else {
    ...
    public void storeRelationship(String ent1, String relationship, String ent2) {
        IRI s = vf.createIRI(entityCollection.ENTITY_PREFIX, ent1);
        IRI p = vf.createIRI(entityCollection.RELATIONSHIP_PREFIX, relationship);
        IRI o = vf.createIRI(entityCollection.ENTITY_PREFIX, ent2);
        model.add(s, p, o);
    }
